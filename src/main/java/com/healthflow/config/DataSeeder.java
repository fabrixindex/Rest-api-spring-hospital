...
public class DataSeeder {
    ...
    CommandLineRunner initDatabase(
        ...
        return args -> {
            ...
            hospitalRoomRepository.save(room);
            ...
            // Crear medicamentos con stock y fecha de vencimiento
            Medication med1 = new Medication(null, "Paracetamol", "500mg cada 8 horas", "Analgésico y antipirético", 100, LocalDate.now().plusMonths(12));
            Medication med2 = new Medication(null, "Enalapril", "10mg una vez al día", "Antihipertensivo", 50, LocalDate.now().plusMonths(18));
            ...
            System.out.println("✅ Datos de prueba reinicializados correctamente.");
        };
    }
}
 */